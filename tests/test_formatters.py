...
- Never modify files in `src/runtime/autogen/` directly.

## Conventions

Use conventional commits with scope: `feat(auth): description`.
"""


@pytest.fixture
def sample_synthesis() -> SynthesisResult:
    """A SynthesisResult with freeform markdown content."""
    return SynthesisResult(
        content=_SAMPLE_CONTENT.strip(),
